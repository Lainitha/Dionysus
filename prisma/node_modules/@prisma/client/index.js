...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\Projects\\GITHUB_SAAS\\dionysus_yt\\prisma\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "E:\\Projects\\GITHUB_SAAS\\dionysus_yt\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://neondb_owner:npg_4haxHYqpZwv1@ep-black-dream-a1r6q0vt-pooler.ap-southeast-1.aws.neon.tech/cidax?sslmode=require"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"./node_modules/@prisma/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Post {\n  id        Int      @id @default(autoincrement())\n  name      String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  @@index([name])\n}\n",
  "inlineSchemaHash": "b7cf1b4bf1197473e20b0c7ec846675fc459492fe02863cd1d0683aede595d0d",
  "copyEngine": true
}
